/**Function Created in SI to fix Work Order List View Trailing Slide option fix.
 * Describe this function...
 * @param {IClientAPI} clientAPI
 */
//export default function ContextMenuItems(clientAPI) {
//}
...
export function getWorkOrderMenuItems() {
    return [
        ...
        },
        {
            ...
            'Text': '$(L,edit)',
            'Mode': 'Normal',            
            'OnSwipe': '/SmartInspections/Rules/2210/WorkOrderListView/WorkOrderUpdateNav_WOListViewTrailing.js',
        },
        {
